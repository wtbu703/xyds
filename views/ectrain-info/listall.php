...
<script type="text/javascript">
    var pageUrl = "<?=yii::$app->urlManager->createUrl('ectrain-info/find-by-attri')?>";
    var editUrl = "<?=yii::$app->urlManager->createUrl('ectrain-info/update')?>";
    var deleteUrl = "<?=yii::$app->urlManager->createUrl('ectrain-info/delete-one')?>"
    var deleteallUrl = "<?=yii::$app->urlManager->createUrl('ectrain-info/delete-more')?>"
    var detailUrl = "<?=yii::$app->urlManager->createUrl('ectrain-info/find-one')?>"
</script>
<script language="javascript" type="text/javascript" src="js/admin/ectrain-info/listall.js" charset="utf-8"></script>
...
<form action="<?=yii::$app->urlManager->createUrl('ectrain-info/find-by-attri')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="ectrain-info/find-by-attri"/>
    <input type="hidden" id="pre-page" name="pre-page" value="<?=$pages->pageSize?>"/>
    <input type="hidden" id="trainId" name="trainId" value="<?=$para['trainId']?>"/>
</form>
