                ...
                <div style='overflow-y:auto;overflow-x:hidden' class='scrolltable'>
                    <table width="100%" cellspacing="0" class="table_form contentWrap">
                        ...
                        <tr>
                            ...
                            <td><input type="text" style="width:250px;" name="trainId" id="trainId" value="<?=$ectrainInfo->trainId?>" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');" class="input-text"/></td>
                        ...
                        <tr>
                            ...
                            <td><input id="published" name="published" type="text" value="<?=$ectrainInfo->published?>" class="date">
