                ...
                <div id="div_setting_1" class="contentList pad-10">
                    <div style='overflow-y:auto;overflow-x:hidden' class='scrolltable'>
                        <table width="90%" cellspacing="0" class="table_form contentWrap">
                            ...
                            <tr>
                                <th >中央财政资金支持总金额：</th>
                                <td><input type="text" style="width:250px;" name="centralSupport" id="centralSupport" value="<?=$ectrainInfo->centralSupport?>" class="input-text"/>万元</td>
                            </tr>
                            <tr>
                                <th>中央财政资金已拨付金额：</th>
                                <td><input type="text" style="width:250px;" name="centralPaid" id="centralPaid" value="<?=$ectrainInfo->centralPaid?>" class="input-text"/>万元</td>
                            </tr>
                            <tr>
                                <th>地方财政配套资金总金额：</th>
                                <td><input type="text" style="width:250px;" name="localSupport" id="localSupport" value="<?=$ectrainInfo->localSupport?>" class="input-text"/>万元</td>
                            </tr>
                            <tr>
                                <th>企业投入资金总金额：</th>
                                <td><input type="text" style="width:250px;" name="companyPaid" id="companyPaid" value="<?=$ectrainInfo->companyPaid?>" class="input-text"/>万元</td>
                            </tr>
                            <tr>
                                <th>项目承办单位：</th>
