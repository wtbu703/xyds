...
<head>
    ...
    <script type="text/javascript">
        var deleteAdminAccessUrl = "<?=yii::$app->urlManager->createUrl('role/delete-one-admin-access')?>"
        var deleteMoreAdminAccessUrl = "<?=yii::$app->urlManager->createUrl('role/delete-more-admin-access')?>"
        var adminAddAccessUrl= "<?=yii::$app->urlManager->createUrl('role/add-admin-access')?>";
        var adminControlUrl= "<?=yii::$app->urlManager->createUrl('role/admin-control')?>";
    </script>
    <script language="javascript" type="text/javascript" src="js/admin/role/admincontrol.js" charset="utf-8"></script>
    <script language="javascript" type="text/javascript" src="js/page.js" charset="utf-8"></script>
</head>
<body>
    <div class="subnav" id="display" >
        <div class="content-menu ib-a blue line-x">
            <a class="add fb" href="javascript:openAddAdminAccess('<?=$role->id?>','<?=$role->name?>');"><em>分配用户</em></a>
        ...
        <div class="pad-lr-10">
            <div class="table-list">
                <table width="100%" cellspacing="0" id="user_list">
                    ...
                    <tr align="left">
                        <th width="80px"><input type="checkbox" id='check_box' onclick="selectall('id')"/>全选/取消</th><th width="80px">序号</th><th width="160px">用户名</th><th width="160px">真实姓名</th><th width="80px" align="center">用户状态</th><th align="center">操作</th>
                    </tr>
                    </thead>
...
<form action="<?=yii::$app->urlManager->createUrl('role/admin-control')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="role/admin-control"/>
