...
<head>
    ...
    <script type="text/javascript">
        var AddOneRoleResourceUrl = "<?=yii::$app->urlManager->createUrl('role/add-more-role-resource')?>"
        var resourceControlUrl= "<?=yii::$app->urlManager->createUrl('role/resource-control')?>";
    </script>
    <script language="javascript" type="text/javascript" src="js/admin/role/AddRoleResource.js" charset="utf-8"></script>
        ...
        <div class="pad-lr-10">
            <div class="table-list">
                <table width="100%" cellspacing="0" id="role_list">
                    ...
                    <tr align="left">
                        <th width="80px"><input type="checkbox" id='check_box' onclick="selectall('id')"/>全选/取消</th><th width="80px">序号</th><th width="160px">控制器名</th><th width="160px">操作名</th><th width="160px" align="center">注释</th>
                    </tr>
                    </thead>
                ...
                <div class="btn">
                    ...
                    <input type="button" class="buttonde" name="dosubmit" value="添加" onclick="addRoleResource('<?=$role->id?>')"/>&nbsp;&nbsp;
                    <input type="button" class="buttondel" name="dosubmit1" value="关闭" onclick="window.top.$.dialog.get('role_resource').close();"/>
                </div>
                <div id="pages">
...
<form action="<?=yii::$app->urlManager->createUrl('role/add-role-resource')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="role/add-role-resource"/>
