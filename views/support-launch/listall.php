<script type="text/javascript">
    var findOneUrl = "<?=Yii::$app->urlManager->createUrl('support-launch/find-one')?>";
    var deleteOneUrl = "<?=Yii::$app->urlManager->createUrl('support-launch/delete-one')?>";
    var deleteMoreUrl = "<?=Yii::$app->urlManager->createUrl('support-launch/delete-more')?>";
</script>
<script language="javascript" type="text/javascript" src="js/admin/support-launch/listall.js" charset="utf-8"></script>
<div class="pad-lr-10">
    <div class="table-list">
        <table width="100%" cellspacing="0">
            ...
            <tbody>
            <?if(!is_null($supportLaunchs)){?>
	            <?php foreach ($supportLaunchs as $index => $val){?>
	                <tr align="center">
...
<form action="<?=Yii::$app->urlManager->createUrl('support-launch/find-by-attri')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="support-launch/find-by-attri"/>
