...
<script type="text/javascript">
    var pageUrl = "<?=yii::$app->urlManager->createUrl('company-news/find-by-attri')?>";
    var editUrl = "<?=yii::$app->urlManager->createUrl('company-news/update')?>";
    var deleteUrl = "<?=yii::$app->urlManager->createUrl('company-news/delete-one')?>"
    var deleteallUrl = "<?=yii::$app->urlManager->createUrl('company-news/delete-more')?>"
    var detailUrl = "<?=yii::$app->urlManager->createUrl('company-news/find-one')?>"
</script>
<script language="javascript" type="text/javascript" src="js/admin/company-news/listall.js" charset="utf-8"></script>
</head>
<body>
    <div class="pad-lr-10">
        <div class="table-list">
            <table width="100%" cellspacing="0" id="user_list">
                ...
                <tr align="left">
                    <th width="80px"><input type="checkbox" id='check_box' onclick="selectall('id')"/>全选/取消</th><th width="30px">序号</th><th width="360px">新闻标题</th><th width="160px">关键词</th><th width="160px">发布时间</th><th align="center">操作</th>
                </tr>
                </thead>
                ...
                <?php foreach ($companyNews as $index => $val){?>
                    <tr align="left">
                        ...
                        <td align="center">
                            ...
                            |&nbsp;&nbsp;<a href="javascript:deleteCompanyNews('<?=$val->id?>')">删除</a>
                        </td>
                   </tr>
                    <?}?>
                    <?}?>
...
<form action="<?=yii::$app->urlManager->createUrl('company-news/find-by-attri')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="company-news/find-by-attri"/>
