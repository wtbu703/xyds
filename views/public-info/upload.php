...
<script type="text/javascript" src="js/admin/public-info/upload.js"></script>
</head>
<body>
    <form id="uploadForm" name="form1" method="post" action="<?=yii::$app->urlManager->createUrl('public-info/upload')?>" enctype="multipart/form-data">
