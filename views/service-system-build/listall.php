<script type="text/javascript">
    var findOneUrl = "<?=Yii::$app->urlManager->createUrl('service-system-build/find-one')?>";
    var deleteOneUrl = "<?=Yii::$app->urlManager->createUrl('service-system-build/delete-one')?>";
    var deleteMoreUrl = "<?=Yii::$app->urlManager->createUrl('service-system-build/delete-more')?>";
</script>
<script language="javascript" type="text/javascript" src="js/admin/system-build/listall.js" charset="utf-8"></script>
<div class="pad-lr-10">
    <div class="table-list">
        <table width="100%" cellspacing="0">
            ...
            <tbody>
            <?if(!is_null($serviceSystemBuilds)){?>
	            <?php foreach ($serviceSystemBuilds as $index => $val){?>
	                <tr align="center">
...
<form action="<?=Yii::$app->urlManager->createUrl('service-system-build/find-by-attri')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="service-system-build/find-by-attri"/>
