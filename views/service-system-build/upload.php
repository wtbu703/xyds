...
<script type="text/javascript" src="js/admin/system-build/upload.js"></script>

<form id="uploadForm" name="form1" method="post" action="<?=Yii::$app->urlManager->createUrl('service-system-build/upload')?>" enctype="multipart/form-data">
