...
<html lang="<?= Yii::$app->language ?>" xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <script type="text/javascript">
            var editUrl = "<?=yii::$app->urlManager->createUrl('adminmanage/update')?>";
            var deleteUrl = "<?=yii::$app->urlManager->createUrl('adminmanage/deleteone')?>"
            var deleteallUrl = "<?=yii::$app->urlManager->createUrl('adminmanage/deletemore')?>"
            var detailUrl = "<?=yii::$app->urlManager->createUrl('adminmanage/findone')?>"
            /*var resetUrl = "<?=yii::$app->urlManager->createUrl('adminmanage/reset')?>"*/
        </script>
...
<form action="<?=yii::$app->urlManager->createUrl('adminmanage/findbyattri')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="adminmanage/findbyattri"/>
