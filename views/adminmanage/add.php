...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            var checkusernameUrl = "<?=yii::$app->urlManager->createUrl('adminmanage/checkusername')?>";
            var insertUrl = "<?=yii::$app->urlManager->createUrl('adminmanage/addone')?>";
            var listallUrl = "<?=yii::$app->urlManager->createUrl('adminmanage/list')?>";
        </script>
