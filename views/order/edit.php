...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="js/fancybox/jquery.fancybox-1.3.4.css" media="screen" />
    <script>
        var updateUrl = "<?=yii::$app->urlManager->createUrl('order/update-one')?>";
    </script>
    <script language="javascript" type="text/javascript" src="js/admin/order/edit.js" charset="utf-8"></script>
</head>
        ...
        <div class="pad-10">
            <div class="col-tab">
                <ul class="tabBut cu-li">
                    <li id="tab_setting_1" class="on" onclick="">修改订单</li>
                </ul>
                <div id="div_setting_1" class="contentList pad-10">
                    <div style='overflow-y:auto;overflow-x:hidden' class='scrolltable'>
                        <table width="90%" cellspacing="0" class="table_form contentWrap">
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="address" value="<?=$userorder->address?>"/></td>
                                <input type="hidden" id="id"value="<?=$userorder->id?>" />
                            </tr>
                            <tr>
                                <th width="100">邮政编码</th>
                                <td><input type="text" id="postCode"  class="input-text" style="width:270px;" value="<?=$userorder->postCode?>" /></td>
                            </tr>
                            <tr>
                                <th width="100">联系方式</th>
                                <td><input type="text" id="mobile"  class="input-text" style="width:270px;" value="<?=$userorder->mobile?>" /></td>
                            </tr>
                            <tr>
                                <th width="100">收件人</th>
                                <td><input type="text" id="name"  class="input-text" style="width:270px;" value="<?=$userorder->name?>" /></td>
                            </tr>
                            <tr>
                                <th width="100">金额</th>
                                <td><input type="text" id="cost"  class="input-text" style="width:270px;" value="<?=$userorder->cost?>" /></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="rightbtn">
                        ...
                        &nbsp;&nbsp;<input type="button" class="buttondel" name="dosubmit" value="关闭" onclick="window.top.$.dialog.get('order_update').close();"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                </div>
            </div>
