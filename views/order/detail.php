        ...
        <div class="pad_10">
            <div style='overflow-y:auto;overflow-x:hidden' class='scrolltable'>
                <table width="100%" cellspacing="0" class="table_form contentWrap">
                    <tr>
                        <th width="100">订单号</th>
                        <td id="orderNo"><?=$userorder->orderNo?></td>
                    </tr>
                    <tr>
                        <th width="100">用户ID</th>
                        <td id="userID"><?=$userorder->userID?></td>
                    </tr>
                    <tr>
                        <th width="100">收件人</th>
                        <td id="name"><?=$userorder->name?></td>
                    </tr>
                    <tr>
                        <th width="100">联系方式</th>
                        <td id="mobile"><?=$userorder->mobile?></td>
                    </tr>
                    <tr>
                        <th width="100">收货地址</th>
                        <td id="address"><?=$userorder->address?></td>
                    </tr>
                    <tr>
                        <th width="100">邮政编码</th>
                        <td id="postCode"><?=$userorder->postCode?></td>
                    </tr>
                    <tr>
                        <th width="100">金额</th>
                        <td id="cost"><?=$userorder->cost?></td>
                    </tr>
                    <tr>
                        <th width="100">下单时间</th>
                        <td id="dateTime"><?=$userorder->dateTime?></td>
                    </tr>
                </table>
            </div>
            <div class="bk10"></div>
            ...
            <div class="table-list">
                ...
                <div class="rightbtn">
                    <input type="button" class="buttonclose" name="dosubmit" value="关闭" onclick="window.top.$.dialog.get('order_detail').close();" />
                </div>
            </div>
    </form>
</div>
