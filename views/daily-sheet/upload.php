...
<script type="text/javascript" src="js/admin/daily-sheet/upload.js"></script>

<form id="uploadForm" name="form1" method="post" action="<?=yii::$app->urlManager->createUrl('daily-sheet/upload')?>" enctype="multipart/form-data">
