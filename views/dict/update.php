...
<html lang="<?= Yii::$app->language ?>" xmlns="http://www.w3.org/1999/html">
    <head>
        ...
        <script type="text/javascript">
            ...
            var updateUrl = '<?=yii::$app->urlManager->createUrl('dict/updateone')?>';
            var deleteUrl = '<?=yii::$app->urlManager->createUrl('dict/deleteoneitem')?>';
        </script>
        <script language="javascript" type="text/javascript" src="js/admin/dict/update.js" charset="utf-8"></script>
    </head>
    <body>
        <div class="pad-lr-10">
            <form action="<?=yii::$app->urlManager->createUrl('dict/updateone')?>" id="dictForm" name="dictForm" method="post" target="iframeId">
                <div class="pad_10">
