        ...
        <form id="myform" action="" method="post">
            <div class="pad_10">
                <div style='overflow-y:auto;overflow-x:hidden' class='scrolltable'>
                    <table width="100%" cellspacing="0" class="table_form contentWrap">
                        <tr>
                            ...
                            <td id="dictId"><?=$dict->dictCode?></td>
                        </tr>
                        <tr>
                            <th width="100">字典组名称</th>
                            <td id="dictName"><?=$dict->dictName?></td>
                        </tr>
                        <tr>
                            <th>简介</th>
                            <td id="dictState"><?=$dict->intro?></td>
                        </tr>
                        <tr>
                            <th>状态</th>
                            <td id="dictState"><?=$dict->state?></td>
                        </tr>
                    </table>
                </div>
                <div class="bk10"></div>
                ...
                <div class="table-list">
                        ...
                        <tbody id="modelTplTB">
                            <?php if(!is_null($dictItems)){?>
                                <?php foreach ($dictItems as $index => $dictitem){?>
                                    <tr id="">
                                        <td align="left"><?=$dictitem->orderBy?></td>
                                        <td align="left"><?=$dictitem->dictItemCode?></td>
                                        <td align="left"><?=$dictitem->dictItemName?></td>
                                    </tr>
                                <?}?>
                            <?}?>
                        </tbody>
                    ...
                    <div class="rightbtn">
                        <input type="button" class="buttonclose" name="dosubmit" value="关闭" onclick="window.top.$.dialog.get('dict_detail').close();" />
                    </div>
                </div>
        </form>
        </div>
