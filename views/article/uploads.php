...
<form id="uploadForm" name="form1" method="post" action="<?=yii::$app->urlManager->createUrl('article/uploads')?>" enctype="multipart/form-data">
    ...
    <input type="button" class="buttonsave" onClick="uploadPic();"  value="上传"/> <span style="font-size: 6px;color: #7d8289;">限制分辨率为750*510（宽*高），大小不超过2M！</span><div id="productPWDAgainTip"></div>
