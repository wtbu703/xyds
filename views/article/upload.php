...
<script type="text/javascript" src="js/admin/article/upload.js"></script>

<form id="uploadForm" name="form1" method="post" action="<?=yii::$app->urlManager->createUrl('article/upload')?>" enctype="multipart/form-data">
