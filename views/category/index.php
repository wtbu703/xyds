...
<div class="subnav" id="display" >
    <div class="content-menu ib-a blue line-x">
        <a class="add fb" href="javascript:openadd();"><em>添加商品大类</em></a>
    </div>
</div>
<div class="pad-lr-10">
    ...
    <div class="table-list">
        <iframe scrolling="auto" width="100%" height="450" id="iframeId" name="iframeId" frameborder="0" onLoad="iFrameHeight()" src="<?=Yii::$app->urlManager->createUrl('category/find-by-attri')?>"></iframe>
    </div>
</div>