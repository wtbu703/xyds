...
<script type="text/javascript" src="js/admin/county-economic/upload.js"></script>

<form id="uploadForm" name="form1" method="post" action="<?=yii::$app->urlManager->createUrl('county-economic/upload')?>" enctype="multipart/form-data">
