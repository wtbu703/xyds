...
<script type="text/javascript">
    ...
    var addUrl = "<?=yii::$app->urlManager->createUrl('company/add')?>";
    var listallUrl  = "<?=yii::$app->urlManager->createUrl('company/find-by-attri')?>";
</script>
<script language="javascript" type="text/javascript" src="js/admin/company/list.js" charset="utf-8"></script>
<div class="subnav" id="display" >
    <div class="content-menu ib-a blue line-x">
        <a class="add fb" href="javascript:openadd();"><em>添加企业</em></a>
    </div>
</div>
...
<div class="pad-lr-10">
    ...
    <div class="table-list">
        <iframe id="iframeId" name="iframeId" src="<?=yii::$app->urlManager->createUrl('company/find-by-attri')?>"  frameBorder=0 scrolling=no width="100%" onLoad="iFrameHeight()"></iframe>
    </div>
</div>
