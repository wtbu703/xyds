...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            //var addUrl = "<?=yii::$app->urlManager->createUrl('user/add')?>";
            var listallUrl  = "<?=yii::$app->urlManager->createUrl('user/find-by-attri')?>";
        </script>
    ...
    <body>
        <div class="subnav" id="display" >
            <!--<div class="content-menu ib-a blue line-x">
                <a class="add fb" href="javascript:openadd();void(0);"><em>添加用户</em></a>
            </div>-->
        </div>
        <div class="pad-lr-10">
            ...
            <div class="table-list">
                <iframe id="iframeId" name="iframeId" src="<?=yii::$app->urlManager->createUrl('user/find-by-attri')?>"  frameBorder=0 scrolling=no width="100%" onLoad="iFrameHeight()"></iframe>
            </div>
        </div>
    </body>
</html>