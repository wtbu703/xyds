...
<script type="text/javascript">
    var pageUrl = "<?=yii::$app->urlManager->createUrl('video/findbyattri')?>";
    var editUrl = "<?=yii::$app->urlManager->createUrl('video/update')?>";
    var deleteUrl = "<?=yii::$app->urlManager->createUrl('video/deleteone')?>"
    var deleteallUrl = "<?=yii::$app->urlManager->createUrl('video/deletemore')?>"
    var detailUrl = "<?=yii::$app->urlManager->createUrl('video/findone')?>"
</script>
<script language="javascript" type="text/javascript" src="js/admin/video/listall.js" charset="utf-8"></script>
...
<form action="<?=yii::$app->urlManager->createUrl('video/findbyattri')?>" method="get" id="pageForm">
    <input type="hidden" id="page" name="page" value="<?=$pages->page?>"/>
    <input type="hidden"  name="r" value="video/findbyattri"/>
    <input type="hidden" id="pre-page" name="pre-page" value="<?=$pages->pageSize?>"/>
    <input type="hidden" id="name" name="name" value="<?=$para['name']?>"/>
    <input type="hidden" id="source" name="truename" value="<?=$para['source']?>"/>
</form>
