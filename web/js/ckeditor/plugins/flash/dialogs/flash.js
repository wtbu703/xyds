...
(function () {
	...
	CKEDITOR.dialog.add("flash", function (i) {
		...
		return {title:i.lang.flash.title, minWidth:420, minHeight:310, onShow:function () {
			...
			if (n) {
				...
				for (var s = 0, t = r.count(); s < t; s++) {
					p[r.getItem(s).getAttribute("name")] = r.getItem(s);
				}
			}
			var u = {}, v = {};
		...
		}, contents:[{id:"info", label:i.lang.common.generalTab, accessKey:"I", elements:[{type:"vbox", padding:0, children:[{type:"hbox", widths:["280px", "110px"], align:"right", children:[{id:"src", type:"text", label:i.lang.common.url, required:true, validate:CKEDITOR.dialog.validate.notEmpty(i.lang.flash.validateSrc), setup:g, commit:h, onLoad:function () {
		...
		}}, {type:"button", id:"browse", filebrowser:"info:src", hidden:true, style:"display:inline-block;margin-top:10px;", label:i.lang.common.browseServer}]}]}, {type:"hbox", widths:["25%", "25%", "25%", "25%", "25%"], children:[{type:"text", id:"width", style:"width:95px", label:i.lang.common.width, validate:CKEDITOR.dialog.validate.integer(i.lang.common.invalidWidth), setup:function (n, o, p, q) {
