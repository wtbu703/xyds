...
TabPanel.prototype = {
  ...
  init : function(){
	...
	this.tabpanel_content =$('.tabpanel_content');
	...
	this.tabpanel_content.height(t_h-this.tabpanel_tab_content.get(0).offsetHeight-22);
  ...
  resize : function(){
      ...
      this.height = this.render.height();
  	  ...
  	  this.tabpanel_content.height(this.height-this.tabpanel_tab_content.get(0).offsetHeight-22);
  	}
