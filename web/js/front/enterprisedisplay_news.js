...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        async: false,
        success:function(data){
            column_list_html.push('<a class="btn btn-default col-xs-12 col-sm-2 col-md-2 tab_btn1 hover tabH" role="button">最新文章</a>');
            $.each(data,function(i,n){
                column_list_html.push('<a class="btn btn-default col-xs-12 col-sm-2 col-md-2 tab_btn1 tabH" role="button">'+ n.dictItemName +'</a>');
            })
            column_list.append(column_list_html.join(''));
        },
        error:function(){
