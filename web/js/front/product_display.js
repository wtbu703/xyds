            ...
            $.each(productdata,function(i,n){//遍历返回的数据
                {
                    ...
                    product_html.push('<a href="'+productDetailUrl+'&productId='+n.id+'"><h5 class="name col-md-8 col-sm-8 col-xs-8">'+n.name+'</h5></a>');
...
function getPage(pageSize,page,totalCount){
    ...
    if(totalPage >1) {
        ...
        if (page > 0) {
            pagehtml.push('<li><a href="javascript:product(\'0\')" class="maodian">首页</a></li>');
            pagehtml.push('<li><a href="javascript:product(' + prev + ')" aria-label="Previous" class="maodian">上一页</a></li>');
        }
        pagehtml.push('<li><a class="maodian" href="javascript:product(' + page + ')">' + next + '</a></li>');
        if (page < last && totalPage > 1) {
            pagehtml.push('<li><a href="javascript:product(' + next + ')" aria-label="Next" class="maodian">下一页</a></li>');
            pagehtml.push('<li><a href="javascript:product(' + last + ')">尾页</a></li>');//跳转到信息公开详情页
        }
        if (totalPage > 1) {
