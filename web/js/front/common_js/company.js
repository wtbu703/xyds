$(document).ready(function(){
    ...
    $.ajax({
        url: 192.168.1.150:8010/xyds/web/index.php?r=company-recruit/company-recruit,//后台给的
        type: "post",//发送方法
        dataType: "json",//返回的数据格式
            ...
            $.each(data,function(i,n){//遍历返回的数据 
                {
                    ...
                    recruit_html.push('<div class="recruit clearfix"><div></div><a href="recruitment.html">'+n.position+'</a>');
