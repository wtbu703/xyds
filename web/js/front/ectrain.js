        ...
        success:function(data){
            $.each(data,function(i,n){   
                ...
                if(i == 0)
                {
                    ...
                    trainInform_html.push('<h5><a href="'+detailUrl+'&id='+n.id+'">'+ n.name +'</a></h5>');
                    trainInform_html.push('<a href="'+detailUrl+'&id='+n.id+'"><img class=" img-responsive" src="'+ n.picUrl +'" alt="培训通知"></a>');
                    trainInform_html.push('<p><a href="'+detailUrl+'&id='+n.id+'">'+ n.content +'</a></p>');
                    trainInform_html.push('</div>');
                    trainInform_html.push('<div class="col-xs-12 col-sm-12 col-md-6">');
                    trainInform_html.push('<ul class="list_train">');
                }
                
                trainInform_html.push('<li><h5><a href="'+detailUrl+'&id='+n.id+'">'+ n.name +'</a></h5><span>'+ out +'</span></li>');
